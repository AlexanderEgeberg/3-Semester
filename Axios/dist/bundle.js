...
var URI = "https://axiosrs.azurewebsites.net/api/localItems";
var getButton1 = document.getElementById("btnRequest1");
getButton1.addEventListener("click", performGetRequest1);
var getButton2 = document.getElementById("btnRequest2");
getButton2.addEventListener("click", performGetRequest3);
var post = document.getElementById("todoInputForm");
post.addEventListener("submit", performPostRequest);
var clear1 = document.getElementById("clearRequest1");
clear1.addEventListener("click", Clear1);
var clear2 = document.getElementById("clearRequest2");
clear2.addEventListener("click", Clear2);
var clear3 = document.getElementById("clearPost");
...
function performPostRequest(e) {
    var resultElement = document.getElementById("postResult");
    var postTitle = document.getElementById("todoTitle");
    ...
    resultElement.innerHTML = "";
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.post(URI, {
        id: 1,
